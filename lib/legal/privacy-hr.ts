...
export const privacyHr: LegalDocument = {
  ...
  callout: 'Korištenjem naših usluga dostupnih na https://app.unitlift.com i u mobilnoj aplikaciji UnitLift prihvaćate uvjete opisane u ovoj Politici privatnosti. Molimo pročitajte je pažljivo.',
  sections: [
    {
      id: 'tko-smo',
      title: '1. Tko smo',

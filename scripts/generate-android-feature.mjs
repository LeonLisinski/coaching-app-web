...
const logoScale = 220 / 51.064583
const logoW = Math.round(82.020836 * logoScale)
const logoH = 220

const groupW = logoW + 56 + 520
const groupX = Math.round((W - groupW) / 2)
const groupY = Math.round((H - logoH) / 2)

const textX = groupX + logoW + 56
const wordmarkY = groupY + 136
const taglineY  = wordmarkY + 76
...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="${W}" height="${H}" viewBox="0 0 ${W} ${H}">
  ...
  <text x="${textX}" y="${wordmarkY}" font-family="'Inter','Helvetica Neue',Arial,sans-serif" font-weight="700" font-size="116" fill="#FFFFFF" letter-spacing="-2">UnitLift</text>
  <text x="${textX}" y="${taglineY}" font-family="'Inter','Helvetica Neue',Arial,sans-serif" font-weight="400" font-size="40" fill="rgba(255,255,255,0.72)" letter-spacing="0.4">Sve što trebaš za coaching.</text>
</svg>`

const outPath = path.join(__dirname, '..', '..', 'Dokumentacija', 'android-feature-graphic.png')
